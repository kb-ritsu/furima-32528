...
ActiveRecord::Schema.define(version: 2020_12_21_101205) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["users_item_id"], name: "index_addresses_on_users_item_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "first_katakana_name", default: "", null: false
    t.string "last_katakana_name", default: "", null: false
  ...
  add_foreign_key "addresses", "users_items"
